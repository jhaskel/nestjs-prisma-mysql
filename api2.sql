...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `local` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `anexo` (
  ...
  `titulo` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0',
  `local` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `frotareservas` (
  ...
  `veiculoId` int DEFAULT NULL,
  `destino` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Copiando dados para a tabela api.frotareservas: ~15 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `frotaveiculos` (
  ...
  `chassi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `km` int DEFAULT NULL,
...
-- Copiando dados para a tabela api.frotaviagem: ~15 rows (aproximadamente)
