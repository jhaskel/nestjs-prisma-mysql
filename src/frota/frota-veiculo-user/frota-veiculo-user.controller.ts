...
export class FrotaVeiculoUserController {
  constructor(private readonly frotaVeiculoUserService: FrotaVeiculoUserService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateFrotaVeiculoUserDto: UpdateFrotaVeiculoUserDto) {
