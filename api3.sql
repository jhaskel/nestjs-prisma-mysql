...
-- Copiando estrutura do banco de dados para golnanetcom_prefe
CREATE DATABASE IF NOT EXISTS `golnanetcom_prefe` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `golnanetcom_prefe`;

-- Copiando estrutura para tabela golnanetcom_prefe.agenda
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `situacao` text,
  `status` varchar(50) NOT NULL DEFAULT 'trabalhando' COMMENT 'trabalhando,ferias,licença,afastado,demitido',
...
-- Copiando dados para a tabela golnanetcom_prefe.agenda: ~9 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.anexo
CREATE TABLE IF NOT EXISTS `anexo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `documentoId` int(11) NOT NULL DEFAULT '0',
...
-- Copiando dados para a tabela golnanetcom_prefe.anexo: ~1 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.config
...
-- Copiando dados para a tabela golnanetcom_prefe.config: ~1 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.declaracao
...
-- Copiando dados para a tabela golnanetcom_prefe.declaracao: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela golnanetcom_prefe.documentos
CREATE TABLE IF NOT EXISTS `documentos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipoId` int(11) NOT NULL,
  `userId` int(11) DEFAULT NULL,
  `setorId` int(11) DEFAULT NULL,
  `anexoId` int(11) DEFAULT NULL,
...
-- Copiando dados para a tabela golnanetcom_prefe.documentos: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.docuser
...
-- Copiando dados para a tabela golnanetcom_prefe.docuser: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.favoritos
...
-- Copiando dados para a tabela golnanetcom_prefe.favoritos: ~2 rows (aproximadamente)
INSERT INTO `favoritos` (`id`, `userId`, `documentoId`) VALUES
	(3, 1, 12),
	(5, 1, 14);

-- Copiando estrutura para tabela golnanetcom_prefe.frotaabastecimento
CREATE TABLE IF NOT EXISTS `frotaabastecimento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) DEFAULT NULL,
  `veiculoId` int(11) DEFAULT NULL,
  `createdAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `kmAt` int(11) DEFAULT NULL,
...
-- Copiando dados para a tabela golnanetcom_prefe.frotaabastecimento: ~13 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.frotareservas
CREATE TABLE IF NOT EXISTS `frotareservas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) DEFAULT NULL,
  `autorizationId` int(11) DEFAULT NULL,
  `veiculoId` int(11) DEFAULT NULL,
  `destino` varchar(250) DEFAULT NULL,
  `motivo` text,
  `status` varchar(100) DEFAULT NULL COMMENT '''pendente'',''aprovado'',''reprovado''',
...
-- Copiando dados para a tabela golnanetcom_prefe.frotareservas: ~16 rows (aproximadamente)
INSERT INTO `frotareservas` (`id`, `userId`, `autorizationId`, `veiculoId`, `destino`, `motivo`, `status`, `reservedTo`, `createdAt`, `modifiedAt`, `isAtivo`) VALUES
	...
	(34, 1, NULL, 1, 'Blumenau', 'Escola Técnica', 'aprovado', '2023-08-04 16:00:00', '2023-08-01 19:20:01', '2023-08-01 19:20:01', 0);

-- Copiando estrutura para tabela golnanetcom_prefe.frotaveiculos
...
-- Copiando dados para a tabela golnanetcom_prefe.frotaveiculos: ~3 rows (aproximadamente)
INSERT INTO `frotaveiculos` (`id`, `setorId`, `responsavelId`, `marca`, `modelo`, `name`, `ano`, `placa`, `chassi`, `km`, `litros`, `image`, `isViagem`, `isAtivo`) VALUES
	(1, 3, 1, 'VW', 'Gol 1.0 plus', 'Gol', '1999', 'mbx3456', '4547851266523', 49352, NULL, 'https://w7.pngwing.com/pngs/522/870/png-transparent-volkswagen-gol-car-vw-saveiro-volkswagen-up-volkswagen-compact-car-sedan-car.png', 0, 1),
...
-- Copiando estrutura para tabela golnanetcom_prefe.frotaveiculouser
...
-- Copiando dados para a tabela golnanetcom_prefe.frotaveiculouser: ~6 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.frotaviagem
...
-- Copiando dados para a tabela golnanetcom_prefe.frotaviagem: ~17 rows (aproximadamente)
INSERT INTO `frotaviagem` (`id`, `veiculoId`, `userId`, `reservaId`, `createdAt`, `finalAt`, `isAtivo`, `isAtiva`, `kmInicial`, `kmFinal`, `destino`, `motivo`) VALUES
	...
	(83, 1, 1, 34, '2023-08-04 14:50:56', '2023-08-04 14:51:07', 1, 0, 49252, 49352, 'Blumenau', 'Escola Técnica');

-- Copiando estrutura para tabela golnanetcom_prefe.messages
CREATE TABLE IF NOT EXISTS `messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `documentoId` int(11) NOT NULL DEFAULT '0',
  `remetente` int(11) NOT NULL DEFAULT '0',
...
-- Copiando dados para a tabela golnanetcom_prefe.messages: ~1 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.setores
CREATE TABLE IF NOT EXISTS `setores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `secretarioId` int(11) DEFAULT NULL,
...
-- Copiando dados para a tabela golnanetcom_prefe.setores: ~18 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.setoruser
...
-- Copiando dados para a tabela golnanetcom_prefe.setoruser: ~9 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.tipos
...
-- Copiando dados para a tabela golnanetcom_prefe.tipos: ~8 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.usercargos
...
-- Copiando dados para a tabela golnanetcom_prefe.usercargos: ~4 rows (aproximadamente)
...
-- Copiando estrutura para tabela golnanetcom_prefe.users
CREATE TABLE IF NOT EXISTS `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role` int(11) NOT NULL DEFAULT '1',
  `idSetor` int(11) NOT NULL DEFAULT '1',
...
-- Copiando dados para a tabela golnanetcom_prefe.users: ~9 rows (aproximadamente)
